...
if config_env() == :prod do
  database_url =
    System.fetch_env!("DATABASE_URL") ||
      raise """
      environment variable DATABASE_URL is missingz.
  ...
  config :retrospector, RetrospectorWeb.Endpoint,
    ...
    url: [host: System.fetch_env!("ORIGIN")],
  ...
  #
  #     config :Retrospector, RetrospectorWeb.Endpoint, server: true
  #
  ...
  #
  #     config :Retrospector, Retrospector.Mailer,
